# Reichelt Auto Import- Frontend Code

This directory contains the frontend code for the Reichelt Auto Import plugin.
...
This will compile the frontend into the `../reichelt_auto_import/static` directory (ready for distribution).
